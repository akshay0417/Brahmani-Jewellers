...
export default function InvestScreen() {
  ...
  const [balance, setBalance] = useState({ goldGrams: 0, silverGrams: 0, transactions: [] });
  ...
  const doMath = (field, val, makingVal, otherVal, metalVal, karatVal) => {
...
const styles = StyleSheet.create({
  ...
  divider: { height: 1, backgroundColor: '#E5E5EA', my: 8, marginVertical: 8 },
